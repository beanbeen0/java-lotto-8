...
public enum Error {
    ...
    WRONG_UNIT_OF_PRICE("투입 금액은 1000원 단위이어야 합니다."),

    DUPLICATED_BONUS_NUMBER("보너스 번호는 당첨 번호들과 중복되지 않아야 합니다."),
    NOT_NUMBER_FORMAT("숫자여야 합니다."),

    DUPLICATED_LOTTO_NUMBERS("로또 번호는 중복될 수 없습니다."),
    WRONG_COUNT_OF_LOTTO_NUMBERS("로또 번호는 6개여야 합니다."),
    WRONG_RANGE_OF_LOTTO_NUMBER("로또 숫자는 1~45 사이의 숫자합니다."),

    WRONG_COUNT_OF_WINNING_NUMBERS("로또 번호는 6개여야 합니다."),
